# Generated by Django 3.2.5 on 2021-07-14 14:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('N', 'Новый курьер'), ('T', 'Ваш заказ в рассмотрении'), ('O', 'В дороге'), ('D', 'Доставлено'), ('С', 'Отменён')], max_length=100)),
            ],
            options={
                'verbose_name': 'Заказ',
